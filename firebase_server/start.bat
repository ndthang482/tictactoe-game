copy .\Update\tictactoe-game-1.0-SNAPSHOT.gar .\game\deploy
@ECHO off
set CLASS_P=conf
...
java %JMX% %* -Djava.net.preferIPv4Stack=true -Xms%MAXMEMORY% -Xmx%MAXMEMORY% -XX:+UseParallelGC -classpath %CLASS_P% %MAIN_CLASS% -n singleton